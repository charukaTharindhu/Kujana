...
namespace MVC_DynamicMenu.Repo
{
	public class UserRepo
	{
		...
		public void InitRoleMenus()
		{
			...
			rm[33].Menu = "Case Note";
			rm[33].Url = "/CaseNote/getAllCaseNote";

			rm[34].Menu = "On Call Dashboard";
			rm[34].Url = "/CallNote/ShowAllCallNote";

			rm[35].Menu = "Work";
			rm[35].Url = "#";

			rm[36].Menu = "Uavailability";
			rm[36].Url = "/Unavailability/GetAllUnavailability";

			rm[37].Menu = "Leave";
			rm[37].Url = "/Leave/GetAllLeave";
