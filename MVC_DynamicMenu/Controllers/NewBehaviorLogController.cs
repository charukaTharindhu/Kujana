...
namespace MVC_DynamicMenu.Controllers
{
    public class NewBehaviorLogController : Controller
    {
        ...
        {
            var newUser = _BehaviorRepo.getUserById(id);
            HttpContext.Session.SetString("loggedname", newUser.Client);
        }
        [HttpGet]
        ...
        [HttpPost]
        public ActionResult AddNewBehavior(NewBehaviorLog behaviorLog)
        {
